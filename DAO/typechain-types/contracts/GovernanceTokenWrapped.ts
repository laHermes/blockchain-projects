...
export interface GovernanceTokenWrappedInterface extends utils.Interface {
  functions: {
...
export interface GovernanceTokenWrapped extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernanceTokenWrappedInterface;
